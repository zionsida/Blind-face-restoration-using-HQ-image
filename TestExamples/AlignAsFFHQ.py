...
if __name__ == '__main__':
    import natsort
    path_dir = '/home/undergrad_te/siondijun/originimg'
    file_list = os.listdir(path_dir)
    file_list=natsort.natsorted(file_list)
    for dataforder in file_list:
        if os.listdir(path_dir+'/'+dataforder) :
            ...
            parser.add_argument('-s', '--src', default=path_dir+'/'+dataforder, help='directory of raw images')
            parser.add_argument('-d', '--dst', default='/home/undergrad_te/siondijun/Alignimgs'+'/'+dataforder, help='directory of aligned images')
